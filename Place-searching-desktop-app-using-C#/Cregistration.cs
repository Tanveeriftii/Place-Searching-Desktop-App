...
namespace Project
{
    public partial class Cregistration : Form
    {
        Thread th;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" && textBox2.Text != "")///data will be inserted if all the fields are filled
            {
                ...
                string query = "insert into registration values (@name,@username,@password,@confirmpassword,@contactno,@address )";
        ...
        private void label8_Click(object sender, EventArgs e)  //have an account
        {
            th = new Thread(openNewFrom);
            th.SetApartmentState(ApartmentState.STA);
            th.Start();
